...
def main() -> None:
    ...
    print("  version, and choose \"now\" or a future date/time. Screens with a live push")
    print("  connection start within seconds; the rest on their next heartbeat (~30s).")
    print("  Either way the install is silent.\n")
