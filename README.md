...
Digital signage: a CMS for customers, a monitoring app for Paskall staff, a player for the
...
| `monitoring/` | Paskall staff only: issues accounts and sets their limits. |
