      ...
      <template #visual>
        ...
        <div class="relative pt-10">
          <img
            ...
            class="ml-10 block aspect-[4/4.6] w-[calc(100%-2.5rem)] sm:aspect-[4/3.1] rounded-tl-3xl object-cover sm:ml-16 sm:w-[calc(100%-4rem)]" loading="lazy" decoding="async"
          />
          <div class="absolute top-0 left-0 w-36 rounded-3xl bg-sky-strong p-4 shadow-[0_20px_40px_-24px_rgba(0,24,77,0.5)] sm:w-40 sm:p-5">
          ...
          <ul class="absolute bottom-6 left-0 w-56 rounded-3xl bg-white p-2 shadow-[0_24px_60px_-28px_rgba(0,24,77,0.5)] sm:bottom-8 sm:w-64">
