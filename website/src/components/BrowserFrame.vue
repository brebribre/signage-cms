...
<template>
  <figure class="overflow-hidden rounded-2xl border border-line bg-canvas shadow-[0_30px_80px_-30px_rgba(0,24,77,0.35)]">
    <div class="flex items-center gap-1.5 border-b border-line bg-surface px-3.5 py-2.5">
