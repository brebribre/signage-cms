...
<template>
  <div class="rounded-xl bg-white p-2.5 shadow-[0_24px_60px_-28px_rgba(0,24,77,0.45)] ring-1 ring-line">
    <div
      class="relative overflow-hidden rounded-lg bg-brand-deep ring-1 ring-black/5"
